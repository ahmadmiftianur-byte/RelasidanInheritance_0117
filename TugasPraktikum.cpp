...
int main() {
    // Buat admin
    Admin admin("Ahmi", "ahmi@example.com");
 
    // Buat beberapa member
    Member* m1 = new Member("Bude",  "bude@mail.com");
    Member* m2 = new Member("Saru",  "saru@mail.com");
    Member* m3 = new Member("Dani",  "dani@mail.com");
